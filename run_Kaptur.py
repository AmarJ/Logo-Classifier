...
CNN_IN_HEIGHT = 32
CNN_IN_CH = 3
TRAIN_DIR = '../Kaptur-Data/datasets/training_sets/flickr_logos_27_dataset'
...
def main():
    ...
    img = Image.open(test_image_fn)
    img = img.resize((CNN_IN_WIDTH, CNN_IN_HEIGHT), PIL.Image.ANTIALIAS)
    img.save(test_image_fn)
